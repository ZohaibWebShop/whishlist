...
import {
  require_lib
} from "./chunk-ZVL7GZ5E.js";
import {
  require_cjs
} from "./chunk-JIUY4ZC5.js";
import {
  __commonJS,
  __toESM
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
    ...
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D, onError: U, queryStringArrayFormat: F, cancelToken: new AbortController() }, g({ cancel: () => {
      ...
      let E = x, V = v(s.url);
      return E.hash && !V.hash && w(E).href === V.href && (V.hash = E.hash, s.url = V.href), this.setPage(s, { visitId: G, replace: o, preserveScroll: c, preserveState: h });
    }).then(() => {
...
nprogress/nprogress.js:
   ...
   * @license MIT *)
*/
//# sourceMappingURL=chunk-LPXSPIIF.js.map
