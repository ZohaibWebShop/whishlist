...
import { ThemeContext, getTheme } from '../../utilities/use-theme.esnext';
...
class AppProvider extends Component {
  ...
  getThemeName = () => this.getFeatures().polarisSummerEditions2023 ? 'Polaris-Summer-Editions-2023' : themeNameDefault;
  render() {
    const {
      children
    } = this.props;
