...
export declare function Option({ label, value, id, select, active, allowMultiple, disabled, role, media, onClick, section, index, verticalAlign, onPointerEnter, onFocus, }: OptionProps): React.JSX.Element;
export {};
